  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-10 px-4 md:px-8 lg:px-10">
        <h2 className="text-3xl sm:text-8xl font-semibold mb-4 text-black dark:text-white max-w-4xl">
          How we implement Your our Projects
        </h2>
        <p className="text-neutral-700 dark:text-neutral-300 sm:text-lg max-w-md">
          We implement your projects through a structured timeline that ensures
          transparency and efficiency at every stage. From initial consultation
          to final delivery, we keep you informed and involved, guaranteeing
